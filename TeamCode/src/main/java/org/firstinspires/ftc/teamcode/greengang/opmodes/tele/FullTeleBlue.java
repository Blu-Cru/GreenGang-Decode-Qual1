...
public class FullTeleBlue extends CommandOpMode {
    ...
    public static double SNAP_D = 2;
    public static double COEFF_A = 0.11789, COEFF_B = -3.26094, COEFF_C = 1410.80085;
    public static double HOOD_BASE = 0, HOOD_SLOPE = 0;
    public static double VELO_GAIN = 0, VOLT_NOMINAL = 13.3;
    ...
    public static double manualRPM = 1900;
    ...
    public void run() {
        ...
        double tof = 0.5, vDist = 2, baseRPM = 0;
        ...
        double autoAimHood = Range.clip(HOOD_BASE - (vDist * HOOD_SLOPE), 0, 0);
        ...
        if (autoAimToggle) {
            ...
            if (gamepad1.dpad_left || gamepad2.dpad_left) manualRPM -= 3;
            else if (gamepad1.dpad_right || gamepad2.dpad_right) manualRPM += 3;
        ...
        telemetry.addData("AutoAimTargetVelocity", autoAimRPM);
        telemetry.update();
    }
}/*
package org.firstinspires.ftc.teamcode.greengang.opmodes.tele;
...
public class FullTeleBlue extends CommandOpMode {
    ...
    private double lastError = 0;
    private double pos_hood = 0;
    public static double manualRPM = 2100;
