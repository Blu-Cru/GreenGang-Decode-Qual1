...
public class Red18Ball extends OpMode {
    public static class Paths {
        ...
        public Pose spike2PickUp = new Pose(134.77, 59, Math.toRadians(0/**/));
        public Pose gateCycle = new Pose(135.4, 58.25, Math.toRadians(24.8));
        ...
        switch (pathState) {
            ...
            case GET_GATE_CYCLE:
                ...
                if (pathTimer.getElapsedTimeSeconds()>3.5 && gateCount==1) {
                    follower.setMaxPower(1.0);
                    gateCount+=1;
                    setPathState(Red18Ball.PathState.GATE_CYCLE_SHOOT);
                }
            ...
            case GET_SPIKE3:
                ...
                if (follower.getPose().getX() > 124 || pathTimer.getElapsedTimeSeconds()>4) setPathState(PathState.SPIKE3_SHOOT);
                break;
